...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    if !UserDefaults.standard.bool(forKey: UserInfoStatusKey.colorMode.rawValue) {
      print("no default exists")
    ...
    if !UserDefaults.standard.bool(forKey: kInitialUser) {
      ...
      UserDefaults.standard.set(false, forKey: kInitialUser)
      UserDefaults.standard.set(kDefaultUserID, forKey: kCurrentCalendarUserID)
