...
class HygieneEventsCollectionViewController: UIViewController, MonthViewDelegate, NotifyCollViewEventsDeletedDelegate {
  ...
  override func viewDidLoad() {
    ...
    print(UserDefaults.standard.bool(forKey: kInitialUser))
    if UserDefaults.standard.bool(forKey: kInitialUser) {
      print(currentCalendarUser?.name ?? "No Name")
      calendarUserHygieneEvents = viewModelMainView.getAllHygieneEventsByCalendarUser(calendarUser: currentCalendarUser!, year: Calendar.current.component(.year, from: Date()))
    }
...
//    print("In insertNewHygieneEvent", user?.name, date, event)
  ...
  @objc func loadNewCalendarUser(_ notification: Notification) {
    ...
    UserDefaults.standard.set(currentUser.userID.uuidString, forKey: kCurrentCalendarUserID)
    viewModelMainView.currentUser = currentUser
    UserDefaults.standard.set(kDefaultUserID, forKey: currentUser.userID.uuidString)
...
extension HygieneEventsCollectionViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
